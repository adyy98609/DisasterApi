...
public class DisasterSummaries {
	...
	public DisasterSummaries(String disasterNumber, String ihProgramDeclared, String iaProgramDeclared,
			String paProgramDeclared, String hmProgramDeclared, String state, String declarationDate, String fyDeclared,
			String disasterType, String incidentType, String title, String incidentBeginDate, String incidentEndDate,
			String disasterCloseOutDate, String declaredCountyArea, String placeCode, String hash, String lastRefresh) {
		super();
		this.disasterNumber = disasterNumber;
		this.ihProgramDeclared = ihProgramDeclared;
		this.iaProgramDeclared = iaProgramDeclared;
	...
	public DisasterSummaries() {
		super();
		// TODO Auto-generated constructor stub
	}
	public DisasterSummaries(String data) {
		//super();
		this.data=data;
		// TODO Auto-generated constructor stub
	}
